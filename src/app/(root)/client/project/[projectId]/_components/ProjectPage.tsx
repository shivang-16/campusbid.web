        ...
        <div className="p-8 bg-gray-50 min-h-screen">
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <header className="bg-green-300 text-white py-4 px-6">
                    ...
                    <span className={`text-sm font-medium ${project.status === 'open' ? 'text-green-700' : 'text-red-400'}`}>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <span className="text-gray-800">{new Date(project.deadline).toLocaleDateString()}</span>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex space-x-2 mt-2">
                            {project.skillsRequired.map((skill, index) => (
                                <li key={index} className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">{skill}</li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            {project.supportingDocs.map((doc, index) => (
                                <li key={index} className="flex items-center space-x-3 text-blue-600">
                                        <Image src={doc.fileUrl} alt={doc.fileName} width={100} height={100}/>
                                    <span className="text-sm text-gray-500">({(doc.fileSize / 1024).toFixed(2)} KB)</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-700">{project.college.College_Name}, {project.college.State}</p>
                    ...
                    <div>
                        ...
                        <p className="text-gray-700">{project.location.city.name}, {project.location.state.name}</p>
